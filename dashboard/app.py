...
def list_json_candidates():
    roots = [Path("outputs/json"), Path("outputs_top10/json"), Path("outputs_wsl_mcmc/json"), Path("outputs_novel_followup/json"), Path("outputs_novel_mcmc/json")]
    files = []
    for root in roots:
        if root.exists():
