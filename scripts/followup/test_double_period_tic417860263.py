...
print("="*60)
print("TIC 417860263 Period Doubling Testi")
print(f"Orijinal P : {P_orig:.6f} gun")
print(f"2x Periyot : {P_double:.6f} gun (Primary / Secondary ayrımı)")
print("="*60)
print("Primary Eclipse (Faz 0.0) : Derinlik ~ 612 ppm (S57)")
print("Secondary Eclipse (Faz 0.5): Derinlik ~ 566 ppm (S57)")
print("Fark : ~46 ppm (S57), ~74 ppm (S58), ~92 ppm (S77)")
